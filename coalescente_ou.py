...
def coalescente_ou(k, n, t_max, x_max, alpha, sigma):
    ...
    for i in indices:
        ...
        trayectoria_sup = [x_max+1]*n
        trayectoria_inf = [-x_max-1]*n
...
print(coalescente_ou(k, n, t_max, x_max, alpha, sigma))